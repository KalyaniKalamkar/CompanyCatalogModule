...
<link rel="stylesheet" href="style.css">
    ...
    <body style="background-color: rgb(57, 62, 70);">
        ...
        <h1 style="color: rgb(0, 173, 181);">Search Company</h1>
    <br>
    <form name="frm" method="post" action="searchacc">
        <input type="text" name="cid" placeholder="CompanyId" >
        <br>
        
        <input type="submit" value="Search"  class="btn btn-outline-dark" style="background-color: rgb(0, 173, 181);">
